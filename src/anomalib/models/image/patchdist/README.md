...
This is the implementation of the [LINK]() paper with normalization as described in [PatchDist](https://www.mdpi.com/2504-4990/5/3/42).
...
Probabilistic PatchCore extends the PatchCore methodology by rescaling the output distances into interpretable probabilities that increase the contrast between normal and anomaly data points.
...
`python tools/train.py --model probabilistic_patchcore`
